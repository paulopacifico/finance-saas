...
export function Hero() {
  return (
    <section className="rounded-2xl border border-zinc-200 bg-zinc-50 p-10">
      ...
      <p className="mt-4 max-w-2xl text-base text-zinc-600">
        Landing pública separada do dashboard autenticado para SEO e performance, com foco no
        mercado canadense.
      </p>
